...
export const DAMAGE_RULE_TABLE: readonly RuleTableEntry[] = [
  ...
  { min: 13, max: 16, wound: WoundState.MORTAL, stunPenalty: -3, deathPenalty: 0 },
  ...
  { min: 41, max: 44, wound: WoundState.MORTAL, stunPenalty: null, deathPenalty: -7 },
  { min: 45, max: 48, wound: WoundState.MORTAL, stunPenalty: null, deathPenalty: -8 },
  { min: 49, max: 52, wound: WoundState.MORTAL, stunPenalty: null, deathPenalty: -9 },
  { min: 53, max: 56, wound: WoundState.MORTAL, stunPenalty: null, deathPenalty: -10 },
  { min: 57, max: null, wound: WoundState.MORTAL, stunPenalty: null, deathPenalty: null },
];
...
export const STUN_PENALTY_MAX_DAMAGE = 40;
export const DEATH_PENALTY_MAX_DAMAGE = 56;
